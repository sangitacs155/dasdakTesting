...
{ ?>
<div class="glyphicon glyphicon-menu-down form-focus-trigger" aria-hidden="true" style="
...
<form  method="post" class="clearfix" action="<?php echo site_url('User/register'); ?>">
